...
import { AnimatedSection, AnimatedCounter, AnimatedFeatureCard, AnimatedHero, FloatingElement, ParallaxBackground, AnimatedTestimonial, FAQAccordion, ContactForm, FloatingNav, ScrollToTop, SectionIndicator } from '@/components/landing-components';
...
export default async function HomePage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-violet-50 via-purple-50 to-fuchsia-50 dark:from-gray-950 dark:via-purple-950 dark:to-violet-950 overflow-x-hidden">
            ...
            <FloatingNav>
                <div className="container mx-auto px-4 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        <a href="#features" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">Funkcje</a>
                        <a href="#how-it-works" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">Jak działa?</a>
                        <a href="#testimonials" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">Opinie</a>
                        <a href="#faq" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">FAQ</a>
                        <a href="#contact" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">Kontakt</a>
                    </div>
                    <div className="flex items-center gap-2">
                        <ThemeToggle />
                        <Link href="/login">
            ...
            <AnimatedHero>
                <section className="container mx-auto px-4 py-16 md:py-24 relative">
                    <div className="max-w-5xl mx-auto text-center space-y-8">
                        {/* Floating elements */}
                        <FloatingElement className="absolute -left-20 top-20 hidden lg:block" delay={0}>
                        ...
                        <FloatingElement className="absolute -right-16 top-40 hidden lg:block" delay={0.5}>
                        ...
                        <FloatingElement className="absolute right-10 bottom-20 hidden lg:block" delay={1}>
                        ...
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border bg-background/60 backdrop-blur-sm text-sm font-medium shadow-sm animate-bounce-slow">
                            ...
                            <span className="text-violet-600 dark:text-violet-400 font-semibold">Poziomy A1 - C1</span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                            <Link href="/login">
                                <Button size="lg" className="bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-700 hover:to-fuchsia-700 text-white h-14 px-10 text-lg shadow-xl shadow-violet-500/30 dark:shadow-violet-900/40 group relative overflow-hidden">
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-6 pt-8 text-sm text-muted-foreground">
                            <div className="flex items-center gap-2">
                                <div className="flex -space-x-2">
                                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-violet-400 to-fuchsia-400 border-2 border-background flex items-center justify-center text-xs text-white font-bold">A</div>
                                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-fuchsia-400 to-pink-400 border-2 border-background flex items-center justify-center text-xs text-white font-bold">M</div>
                                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-pink-400 to-rose-400 border-2 border-background flex items-center justify-center text-xs text-white font-bold">K</div>
                                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-400 to-violet-400 border-2 border-background flex items-center justify-center text-xs text-white font-bold">+</div>
                                </div>
            ...
            <AnimatedSection className="py-12 bg-gradient-to-r from-violet-600 via-fuchsia-600 to-pink-600">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-white text-center">
                        <AnimatedCounter end={2500} suffix="+" label="Słówek w bazie" icon={<BookOpen className="w-6 h-6" />} />
                        <AnimatedCounter end={95} suffix="%" label="Skuteczność metody" icon={<Target className="w-6 h-6" />} />
                        <AnimatedCounter end={15} suffix=" min" label="Dziennie wystarczy" icon={<Clock className="w-6 h-6" />} />
                        <AnimatedCounter end={100} suffix="%" label="Za darmo" icon={<Heart className="w-6 h-6" />} />
                    </div>
                </div>
            </AnimatedSection>
                ...
                <AnimatedSection>
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl md:text-5xl font-bold mb-4">
                            Wszystko czego potrzebujesz do <span className="text-violet-600 dark:text-violet-400">efektywnej nauki</span>
                        </h2>
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Nasza platforma łączy sprawdzone metody naukowe z nowoczesną technologią, aby maksymalizować Twoje postępy.
                        </p>
                    </div>
                </AnimatedSection>
                ...
                <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-12">
                    <AnimatedFeatureCard delay={0.4}>
                        <div className="p-6 rounded-2xl border bg-card/60 backdrop-blur-sm text-center group hover:shadow-xl transition-all duration-300">
                            ...
                            <p className="text-sm text-muted-foreground">Czysta nauka bez rozpraszających elementów</p>
                        </div>
                    </AnimatedFeatureCard>
                    <AnimatedFeatureCard delay={0.5}>
                        <div className="p-6 rounded-2xl border bg-card/60 backdrop-blur-sm text-center group hover:shadow-xl transition-all duration-300">
                            ...
                            <p className="text-sm text-muted-foreground">Ucz się z dowolnego urządzenia, gdziekolwiek jesteś</p>
                        </div>
                    </AnimatedFeatureCard>
                    <AnimatedFeatureCard delay={0.6}>
                        <div className="p-6 rounded-2xl border bg-card/60 backdrop-blur-sm text-center group hover:shadow-xl transition-all duration-300">
                            ...
                            <p className="text-sm text-muted-foreground">Regularnie dodajemy nowe funkcje i słówka</p>
                        </div>
                    </AnimatedFeatureCard>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-6xl mx-auto">
                        <AnimatedSection>
                            <div className="text-center mb-16">
                                <h2 className="text-3xl md:text-5xl font-bold mb-4">
                                    Tryby nauki dopasowane do <span className="text-violet-600 dark:text-violet-400">Twoich potrzeb</span>
                                </h2>
                                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                                    Wybierz sposób nauki, który najbardziej Ci odpowiada. Każdy tryb angażuje inny typ pamięci.
                                </p>
                            </div>
                        </AnimatedSection>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            ...
                            <AnimatedFeatureCard delay={0.15}>
                                <LearningModeCard
                                    ...
                                    features={["Obrazy z Pixabay", "Wizualne skojarzenia", "Quiz wyboru"]}
                            ...
                            <AnimatedFeatureCard delay={0.3}>
                                <LearningModeCard
                                    ...
                                    features={["Web Speech API", "Naturalna wymowa", "Powtarzanie audio"]}
                        ...
                        <div className="grid md:grid-cols-3 gap-6 pt-8">
                            <AnimatedFeatureCard delay={0}>
                                <div className="p-6 bg-card/80 backdrop-blur-sm border rounded-2xl group hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">Uczysz się nowego słówka. System zaplanuje powtórkę na jutro.</p>
                                </div>
                            </AnimatedFeatureCard>
                            <AnimatedFeatureCard delay={0.15}>
                                <div className="p-6 bg-card/80 backdrop-blur-sm border rounded-2xl group hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">Każda poprawna odpowiedź wydłuża przerwę: 1 dzień → 3 dni → tydzień → miesiąc.</p>
                                </div>
                            </AnimatedFeatureCard>
                            <AnimatedFeatureCard delay={0.3}>
                                <div className="p-6 bg-card/80 backdrop-blur-sm border rounded-2xl group hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">Słówka przechodzą do pamięci długotrwałej. Pamiętasz je na zawsze!</p>
                                </div>
                            </AnimatedFeatureCard>
                        </div>
                            ...
                            <div className="p-8 bg-card/80 backdrop-blur-sm border-2 border-violet-200 dark:border-violet-800 rounded-3xl max-w-2xl mx-auto">
                                ...
                                <div className="aspect-[16/9] bg-gradient-to-br from-violet-100 to-fuchsia-100 dark:from-violet-900/30 dark:to-fuchsia-900/30 rounded-xl relative overflow-hidden">
                                    ...
                                    <div className="absolute bottom-2 left-4 right-4 flex justify-between text-xs">
                                        <div className="flex items-center gap-2">
                                            <div className="w-4 h-0.5 bg-red-500 opacity-70" style={{ backgroundImage: 'repeating-linear-gradient(to right, rgb(239 68 68), rgb(239 68 68) 4px, transparent 4px, transparent 8px)' }} />
                                            <span className="text-muted-foreground">Bez powtórek</span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <div className="w-4 h-1 bg-gradient-to-r from-violet-500 to-fuchsia-500 rounded-full" />
                                            <span className="text-muted-foreground">Z algorytmem SM-2</span>
                                        </div>
                                    </div>
                                </div>
                                <p className="text-sm text-muted-foreground mt-4 text-center">
                                    Regularne, rozłożone w czasie powtórki sprawiają, że wiedza zostaje z Tobą na zawsze.
                                </p>
                            </div>
                        </AnimatedSection>
                    </div>
                            ...
                            <AnimatedSection direction="left">
                                <div className="space-y-6">
                                    ...
                                    <ul className="space-y-3">
                                        <CEFRLevel level="A1" name="Beginner" description="Podstawowe słownictwo codzienne" />
                                        <CEFRLevel level="A2" name="Elementary" description="Proste rozmowy i opisy" />
                                        <CEFRLevel level="B1" name="Intermediate" description="Tematy ogólne i podróże" />
                                        <CEFRLevel level="B2" name="Upper-Intermediate" description="Złożone tematy i opinie" />
                                        <CEFRLevel level="C1" name="Advanced" description="Zaawansowane słownictwo akademickie" />
                                    </ul>
                                </div>
                            </AnimatedSection>
                                        ...
                                        <div className="relative bg-card/80 backdrop-blur-sm border-2 border-violet-200 dark:border-violet-800 rounded-3xl p-8 shadow-2xl hover:shadow-violet-500/10 transition-shadow duration-500">
                                            <div className="space-y-4">
                                                <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-violet-100 to-fuchsia-100 dark:from-violet-900/30 dark:to-fuchsia-900/30 rounded-xl">
                                                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-violet-500 to-fuchsia-500 flex items-center justify-center text-white font-bold text-lg">B2</div>
                                                    <div>
                                                        <div className="font-bold">Twój aktualny poziom</div>
                                                        <div className="text-sm text-muted-foreground">Upper-Intermediate</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="grid grid-cols-2 gap-4 pt-4">
                                                    <StatBox icon={<BookOpen className="w-5 h-5" />} value="847" label="Słówek" />
                                                    <StatBox icon={<Flame className="w-5 h-5" />} value="12" label="Dni streak" />
                                                    <StatBox icon={<Target className="w-5 h-5" />} value="94%" label="Dokładność" />
                                                    <StatBox icon={<Trophy className="w-5 h-5" />} value="8" label="Osiągnięć" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            {/* Testimonials */}
            <section id="testimonials" className="py-20 bg-gradient-to-b from-transparent via-violet-100/50 to-transparent dark:via-violet-950/30">
                <div className="container mx-auto px-4">
                    <AnimatedSection>
                        <div className="text-center mb-16">
                            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-100 dark:bg-violet-900/30 text-violet-700 dark:text-violet-300 text-sm font-semibold mb-4">
                            ...
                            <h2 className="text-3xl md:text-5xl font-bold mb-4">
                                Co mówią nasi <span className="text-violet-600 dark:text-violet-400">użytkownicy</span>?
                            </h2>
                        </div>
                    </AnimatedSection>
                ...
                <div className="container mx-auto px-4">
                    <AnimatedSection>
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl md:text-5xl font-bold mb-4">
                                Masz <span className="text-violet-600 dark:text-violet-400">pytania</span>?
                            </h2>
                            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            ...
            <section id="contact" className="py-20 bg-gradient-to-b from-transparent via-fuchsia-100/50 to-transparent dark:via-fuchsia-950/30">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <AnimatedSection>
                            <div className="text-center mb-12">
                                ...
                                <h2 className="text-3xl md:text-5xl font-bold mb-4">
                                    Masz pytanie? <span className="text-violet-600 dark:text-violet-400">Napisz do nas!</span>
                                </h2>
                                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                                    Chętnie odpowiemy na Twoje pytania, przyjmiemy sugestie i pomożemy z problemami.
                                </p>
                            </div>
                        </AnimatedSection>
                        ...
                        <AnimatedSection>
                            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-600 via-fuchsia-600 to-pink-600 p-8 md:p-16 text-center text-white shadow-2xl group">
                                ...
                                <div className="relative space-y-6">
                                    ...
                                    <div className="pt-4">
                                        <Link href="/login">
                                            <Button size="lg" className="bg-white text-violet-700 hover:bg-white/90 h-14 px-10 text-lg font-bold shadow-xl group/btn">
                                                Rozpocznij naukę
                    ...
                    <div className="grid md:grid-cols-4 gap-8 mb-8">
                        <div className="space-y-4">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Darmowa platforma do efektywnej nauki angielskiego z wykorzystaniem algorytmu Spaced Repetition.
                            </p>
                        </div>
                        <div>
                            <h4 className="font-semibold mb-4">Platforma</h4>
                            <ul className="space-y-2 text-sm text-muted-foreground">
                                <li><a href="#features" className="hover:text-foreground transition-colors">Funkcje</a></li>
                                <li><a href="#how-it-works" className="hover:text-foreground transition-colors">Jak działa</a></li>
                                <li><a href="#testimonials" className="hover:text-foreground transition-colors">Opinie</a></li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-muted-foreground">
                                <li><span className="text-foreground">Poziomy A1-C1</span></li>
                                <li><span className="text-foreground">Tryby nauki</span></li>
                                <li><span className="text-foreground">Statystyki</span></li>
                                <li><span className="text-foreground">Osiągnięcia</span></li>
                            </ul>
                        </div>
                        <div>
                            <h4 className="font-semibold mb-4">Kontakt</h4>
                            <ul className="space-y-2 text-sm text-muted-foreground">
                                <li><a href="#contact" className="hover:text-foreground transition-colors">Formularz kontaktowy</a></li>
...
function FeatureCard({ icon, title, description, color }: { icon: React.ReactNode, title: string, description: string, color: string }) {
    ...
    return (
        <div className="p-6 rounded-2xl border bg-card/60 backdrop-blur-sm hover:shadow-xl hover:scale-105 transition-all duration-300 group h-full">
            <div className={`w-12 h-12 rounded-xl ${colorClasses[color as keyof typeof colorClasses]} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
                {icon}
            </div>
...
function LearningModeCard({ icon, title, description, features, color }: { icon: React.ReactNode, title: string, description: string, features: string[], color: string }) {
    return (
        <div className="relative group h-full">
            <div className="absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-10 rounded-2xl transition-opacity" style={{ backgroundImage: `linear-gradient(to bottom right, var(--tw-gradient-stops))` }} />
...
function CEFRLevel({ level, name, description }: { level: string, name: string, description: string }) {
    return (
...
function AchievementCard({ icon, title, description, unlocked = false }: { icon: React.ReactNode, title: string, description: string, unlocked?: boolean }) {
    return (
        <div className={`p-4 rounded-xl border-2 transition-all duration-300 hover:scale-105 ${unlocked ? 'border-amber-400 bg-gradient-to-br from-amber-50 to-yellow-50 dark:from-amber-950/30 dark:to-yellow-950/30 hover:shadow-amber-200/50 dark:hover:shadow-amber-900/30 hover:shadow-lg' : 'border-muted bg-muted/30 opacity-60 hover:opacity-80'}`}>
            <div className={`w-10 h-10 rounded-full flex items-center justify-center mb-3 ${unlocked ? 'bg-gradient-to-br from-amber-400 to-yellow-500 text-white' : 'bg-muted text-muted-foreground'}`}>
                {icon}
            </div>
...
function TestimonialCard({ name, role, content, avatar }: { name: string, role: string, content: string, avatar: string }) {
    return (
        <div className="p-6 rounded-2xl bg-card/80 backdrop-blur-sm border hover:shadow-xl transition-all duration-300 h-full group">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">&ldquo;{content}&rdquo;</p>
