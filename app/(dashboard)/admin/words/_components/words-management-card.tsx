  ...
  return (
    <>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <div className="flex gap-3">
              ...
              <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-success-muted border border-success/20">
                ...
                <div>
                  <div className="text-xs text-success-foreground/70">
                    Zatwierdzone
                  </div>
                ...
                <div className="relative p-4 rounded-xl bg-card border-2 border-warning/20 hover:border-warning/40 transition-colors">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFilters({
                        ...filters,
                        status: value as "all" | "approved" | "pending",
                      })
                    }
                  >
                    <SelectTrigger
                    ...
                    <TableRow key={word.id} className="group">
                      ...
                      <TableCell>
                        <Badge
                          ...
                          className={cn(
                            "font-bold",
                            getLevelBadgeClasses(word.level),
                          )}
                        >
                          {word.level}
                        </Badge>
      ...
      <Dialog
        ...
        onOpenChange={(open) => !open && setEditDialog({ open, word: null })}
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Edytuj słówko</DialogTitle>
            <DialogDescription>Wprowadź zmiany w słówku</DialogDescription>
          </DialogHeader>
