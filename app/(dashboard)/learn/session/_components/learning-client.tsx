...
export function LearningClient({
  ...
  const speak = useCallback(
    (text: string) => {
      ...
      utterance.text = currentWord?.english || text;

      window.speechSynthesis.speak(utterance);
    },
    [soundEnabled, currentWord?.english],
  );
    ...
    return (
      <div className="w-full max-w-2xl mx-auto space-y-6 py-8">
          ...
          <CardContent className="pt-8 pb-8 space-y-6">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-lg text-success-foreground/80">
                Ukończyłeś wszystkie {total}{" "}
                {total === 1 ? "słówko" : total < 5 ? "słówka" : "słówek"} z tej
                sesji
              </p>
            </div>
            ...
            <div className="text-center max-w-md mx-auto">
              <p className="text-base text-slate-700 dark:text-slate-300">
                {accuracy >= 90 ? (
                  <>
                    🌟 Fantastyczna robota, {userName}! Twoje opanowanie
                    materiału jest imponujące!
                  </>
                ) : accuracy >= 70 ? (
                  <>👏 Dobra robota, {userName}! Kontynuuj ciężką pracę!</>
                ) : accuracy >= 50 ? (
                  <>
                    💪 Niezły postęp, {userName}! Powtórka sprawi, że będzie
                    jeszcze lepiej!
                  </>
                ) : (
        ...
        <div className="flex flex-col gap-3">
          <Button
            onClick={() =>
              router.push(sessionType === "review" ? "/review" : "/learn")
            }
    ...
    <div className="w-full max-w-2xl mx-auto space-y-6">
              ...
              <AlertDialogContent>
                  ...
                  <AlertDialogDescription className="space-y-2">
                    ...
                    <p>
                      ...
                      <span className="text-success font-medium">
                        {results.correct} poprawnych
                      </span>
                      ,{" "}
                      <span className="text-error font-medium">
                        {results.incorrect} błędnych
                      </span>
                    </p>
                    <p className="text-sm">
                      Twój dotychczasowy postęp został zapisany. Czy na pewno
                ...
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction
                    onClick={() =>
                      router.push(
                        sessionType === "review" ? "/review" : "/learn",
                      )
                    }
      ...
      <Card
        className={cn(
          ...
          feedback === "correct"
            ? feedbackStyles.correct.card
            : feedback === "incorrect"
              ? feedbackStyles.incorrect.card
        ...
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="relative">
            <Input
              ...
              placeholder={
                isPlToEn ? "Wpisz po angielsku..." : "Wpisz po polsku..."
              }
              className={cn(
              ...
              {feedback && (
                <motion.div
                  ...
                  className={cn(
                    ...
                    feedback === "correct"
                      ? feedbackStyles.correct.badge
                      : feedbackStyles.incorrect.badge,
                  )}
                >
                  {feedback === "correct" ? (
                    <>
