...
test.describe("Panel Administratora (E2E)", () => {
  test("Próba wejścia na /admin/words powinna przekierować niezalogowanego do logowania", async ({
    page,
  }) => {
  ...
  test("Próba wejścia na /admin/users powinna przekierować niezalogowanego do logowania", async ({
    page,
  }) => {
  ...
  test("Próba wejścia na /admin/settings powinna przekierować niezalogowanego do logowania", async ({
    page,
  }) => {
...
test.describe("Strony chronione dashboardu (E2E)", () => {
  test("Strona /statistics powinna przekierować niezalogowanego do logowania", async ({
    page,
  }) => {
  ...
  test("Strona /achievements powinna przekierować niezalogowanego do logowania", async ({
    page,
  }) => {
  ...
  test("Strona /settings powinna przekierować niezalogowanego do logowania", async ({
    page,
  }) => {
  ...
  test("Strona /my-words powinna przekierować niezalogowanego do logowania", async ({
    page,
  }) => {
  ...
  test("Strona /challenge powinna przekierować niezalogowanego do logowania", async ({
    page,
  }) => {
...
test.describe("Strony słówek - chronione (E2E)", () => {
  test("Strona /all-words powinna przekierować niezalogowanego do logowania", async ({
    page,
  }) => {
  ...
  test("Strona /print-words powinna przekierować niezalogowanego do logowania", async ({
    page,
  }) => {
...
test.describe("Security Headers (E2E)", () => {
  ...
  test("Strona główna powinna załadować się bez błędów konsoli", async ({
    page,
  }) => {
...
test.describe("Responsywność UI (E2E)", () => {
  ...
  test("Strona logowania powinna być responsywna na mobile", async ({
    page,
  }) => {
    await page.setViewportSize({ width: 375, height: 667 });
