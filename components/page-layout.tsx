...
export function PageLayout({
  ...
  return (
    <div
      className={`container mx-auto px-8 py-8 flex flex-col flex-1 h-full min-h-screen relative ${maxWidthClasses[maxWidth]}`}
    >
      ...
      {/* Treść strony */}
      <div className="flex-1 space-y-8 pb-4">{children}</div>
